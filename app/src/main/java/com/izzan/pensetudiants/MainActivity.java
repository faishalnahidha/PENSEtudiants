...
public class MainActivity extends AppCompatActivity {
    ...
    public MahasiswaFragment mMahasiswaFragment;
    public ProdiFragment mProdiFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMahasiswaFragment = new MahasiswaFragment();
        mProdiFragment = new ProdiFragment();
...
/*        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
    ...
    public void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(mMahasiswaFragment, "MAHASISWA");
        adapter.addFragment(mProdiFragment, "PRODI");
