...
public class EditMahasiswaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            Long mahasiswaId = extras.getLong("MAHASISWA_ID_EDIT");
        ...
        /**
         * set text field with loaded mMahasiswa's field
         */
        editTextNama.setText(mMahasiswa.getNama());
        editTextNRP.setText(String.valueOf(mMahasiswa.getNrp()));
        actvProdi.setText(mMahasiswa.getProgramStudi().getNamaProdi());
        editTextNoHp.setText(mMahasiswa.getNoHp());
                    ...
                    if (TextUtils.isEmpty(nrp)) {
                        ...
                        if (TextUtils.isEmpty(prodi)) {
                            ...
                            if (found == 1){
                                ...
                                returnIntent.putExtra("NAMA_MAHASISWA_UPDATED", nama);
    ...
    private void saveMahasiswa() {
        ...
        mMahasiswa.setNama(editTextNama.getText().toString().trim());
        String nrp = editTextNRP.getText().toString().trim();
        mMahasiswa.setNrp(Integer.parseInt(nrp));
        mMahasiswa.setNoHp(editTextNoHp.getText().toString().trim());
        ...
        Log.i("EDITED_MAHASISWA", "id = " + mMahasiswa.getId().toString() +
